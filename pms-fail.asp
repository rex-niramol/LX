...
<title>Centara Privilege: Exist recorded</title>
...
<div class="container">
    ...
    <%
        cust_id=request.querystring("guest")

        'Query Information
        rpID = request.querystring("rp")
        strSQL = " SELECT top 1 booking.*, prop.prop_name, prop.prop_name_l_TH, prop.address1 as 'prop_adr', prop.state as 'prop_state', prop.zip as 'prop_zip', prop.phone as 'prop_phone', prop.email_resv as 'prop_email', room.room_name, room.room_name_l_TH, pmprop.contact_email, pmprop.contact_phone from hmc_tb_r_booking booking left join properties prop on(prop.prop_code=booking.prop_code) left join pm_tb_m_properties pmprop on(booking.prop_code=pmprop.prop_code)  left join pm_tb_m_roomtype room on(room.room_code=booking.roomtype  and room.active_sts='1' and booking.prop_code=room.prop_code) where ltrim(rtrim(lower(guest_id)))='"&LCase(Trim(cust_id))&"' and booking.active_sts='1' "
    ...
    <div class="container">
        ...
        <section class="bodytxt">
            <div class="container">
                <div class="row">
                    <p>&nbsp;</p>
                    <p style="font-size: 15px;"><strong>The booking already exist!</strong></p>
                    ...
                    <div class="col-sm-12 contentbox">
                        <div class="col-sm-12" >
                            <div class="col-xs-12 col-sm-6 col-sm-offset-3 border-box text-form title-text" style="padding-top: 10px;padding-bottom: 10px;">
                                <strong><%=dsGeneral.item("hotel_confirmation")%> <%=conf_id%></strong>
                            </div>
                            ...
                            <div class="col-sm-6 col-sm-offset-3 border-box text-small" style="padding-top: 10px; margin-top: 20px;">
                                 ...
                                 <div class="col-sm-12 text-form" style="">	
                                    ...
                                    <br/><br/>
                                    <strong>Centara Privilege Club: Tel. 02-769-1234 Ext 6144-6 | Email <a href="mailto:centaraprivilegeclub@chr.co.th">centaraprivilegeclub@chr.co.th</a></strong>
                                    <br/><br/>
