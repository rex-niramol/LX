...
<title>Centara Privilege: Your booking is now confirmed.</title>
...
<div class="container">
    ...
    <%
        ...
        strSQL = " SELECT top 1 booking.*, prop.prop_name, prop.prop_name_l_TH, prop.address1 as 'prop_adr', prop.state as 'prop_state', prop.zip as 'prop_zip', prop.phone as 'prop_phone', prop.email_resv as 'prop_email', room.room_name, room.room_name_l_TH, pmprop.contact_email, pmprop.contact_phone from hmc_tb_r_booking booking left join properties prop on(prop.prop_code=booking.prop_code) left join pm_tb_m_properties pmprop on(booking.prop_code=pmprop.prop_code)  left join pm_tb_m_roomtype room on(room.room_code=booking.roomtype  and room.active_sts='1' and booking.prop_code=room.prop_code)  where booking.rn_no='"&rpID&"' and booking.active_sts='1' and booking.sale_sts='C' "
    ...
    <div class="container">
        ...
        <section class="bodytxt">
            <div class="container">
                <div class="row">
                    <p>&nbsp;</p>
                    <p style="font-size: 15px;"><strong><%=dsGeneral.item("thank_you")%><br />
                    <%=dsGeneral.item("confirmation_email")%>&nbsp;<%=email%></strong></p>
